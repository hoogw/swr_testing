...
left join ReportLabel on bs.DISPLAY_ORDER = hdrk
order by wo.Location_no, (case when ReportLabel.Sort_Order is null then 1 else 0 end), ReportLabel.Sort_Order--, bs.Bid_Unit
</cfquery>
