...
<cfscript>
    ...
    myQuery.setSql("select coalesce( a.package, '') package, a.location_no, a.Council_District, a.name, a.address, i.tree_planting_contractor, i.ready_to_plant, t.address 'taddress', t.species, t.parkway_treewell_size, t.overhead_wires, t.sub_position, t.offsite, t.Tree_Planting_Date
